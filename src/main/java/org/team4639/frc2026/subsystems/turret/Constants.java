...
public class Constants {
    public static final double TURRET_TO_MOTOR_GEAR_RATIO = 12.0 / 28 * 18 / 40 * 12 / 92;
    public static final double TURRET_DEGREES_PER_MOTOR_ROTATION = TURRET_TO_MOTOR_GEAR_RATIO * 360.0;
