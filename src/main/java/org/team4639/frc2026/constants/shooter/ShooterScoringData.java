...
public class ShooterScoringData {
    private static final InterpolatingDoubleTreeMap scoringDistanceToRPM = InterpolatingDoubleTreeMap.ofEntries(
            ...
            scoringDistanceToHoodAngle = InterpolatingDoubleTreeMap.ofEntries(
                    new AbstractMap.SimpleImmutableEntry<>(1.0, 0.208),
                    new AbstractMap.SimpleImmutableEntry<>(2.0, 0.186),
                    new AbstractMap.SimpleImmutableEntry<>(3.0, 0.173),
                    new AbstractMap.SimpleImmutableEntry<>(4.0, 0.164),
                    new AbstractMap.SimpleImmutableEntry<>(5.0, 0.158),
                    new AbstractMap.SimpleImmutableEntry<>(6.0, 0.154),
                    new AbstractMap.SimpleImmutableEntry<>(7.0, 0.151),
                    new AbstractMap.SimpleImmutableEntry<>(8.0, 0.25- 0.148),
                    new AbstractMap.SimpleImmutableEntry<>(9.0, 0.146),
                    new AbstractMap.SimpleImmutableEntry<>(10.0, 0.144),
                    new AbstractMap.SimpleImmutableEntry<>(11.0, 0.142),
                    new AbstractMap.SimpleImmutableEntry<>(12.0, 0.141),
                    new AbstractMap.SimpleImmutableEntry<>(13.0, 0.140),
                    new AbstractMap.SimpleImmutableEntry<>(14.0, 0.139),
                    new AbstractMap.SimpleImmutableEntry<>(15.0, 0.138),
                    new AbstractMap.SimpleImmutableEntry<>(16.0, 0.137),
                    new AbstractMap.SimpleImmutableEntry<>(17.0, 0.1367),
                    new AbstractMap.SimpleImmutableEntry<>(18.0, 0.1361),
                    new AbstractMap.SimpleImmutableEntry<>(19.0, 0.1356),
                    new AbstractMap.SimpleImmutableEntry<>(20.0, 0.135)
            ),
